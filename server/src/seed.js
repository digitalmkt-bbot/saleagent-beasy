...
async function main() {
  ...
  const actTags = {};
  for (const name of ['สนใจ','ขอสัญญา','ขอคิดดูก่อน','ต่อรองราคา','ปิดการขาย','ไม่สนใจ'])
  ...
  const aDefs = [
    { c:0, p:0, dir:'outbound', m:1, type:0, detail:'โทรติดตามสัญญา', due:addDays(0), status:'pending', stage:4, pri:4, tags:['ขอสัญญา'], assignee:u2 },
