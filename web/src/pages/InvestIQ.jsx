  ...
  function Overview() {
    ...
    return (<>
      <div className="card">
        ...
        <div className="brcards"><div className="brc"><div className="brc-k">Gained</div><div className="brc-v" style={{ color: '#1A191D' }}>+{fmtC(gD + nD)}</div></div><div className="brc"><div className="brc-k">Lost</div><div className="brc-v" style={{ color: '#1A191D' }}>−{fmtC(lD + cD)}</div></div><div className="brc"><div className="brc-k">Net</div><div className="brc-v" style={{ color: '#FF4B26' }}>{(curTot - P >= 0 ? '+' : '−') + fmtC(Math.abs(curTot - P))}</div></div></div>
            ...
            return (
              <div className="bcol" key={s[0]}>
                <div className="bzone">
                  ...
                  <i style={{ bottom: bot, height: ht, ...(/Prev|Stable/.test(s[0]) ? { backgroundColor: '#F1EFF3', backgroundImage: `repeating-linear-gradient(45deg, ${s[3]} 0 3px, transparent 3px 9px)` } : { background: s[3] }) }} /><div className="btip"><b>{s[0]}</b><br />{s[4]}</div>
                </div>
