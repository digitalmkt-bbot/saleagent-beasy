...
const EN = {
  ...
  'เลือกช่วงเดือน': 'Select month range',
  'เลือกเดือนเริ่มต้น': 'Select start month',
  'เลือกเดือนสิ้นสุด': 'Select end month',
  'เลือกเดือนแรกและเดือนสุดท้ายเพื่อเปรียบเทียบ': 'Select the first and last month to compare',
