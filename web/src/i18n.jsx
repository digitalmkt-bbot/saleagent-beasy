...
const EN = {
  ...
  'รายงาน': 'Reports',
  'ดีลที่เปิดอยู่': 'Open deals',
  'อัตราปิดการขาย': 'Win rate',
  'ดูรายงาน →': 'View report →',
  'ดีลที่ปิดได้': 'Deals won',
  'รวมทั้งหมด': 'Total',
  'ความคืบหน้าไปป์ไลน์': 'Pipeline progress',
  'สำเร็จ': 'Complete',
  'กำลังไป': 'On track',
  'แนวโน้มยอดขายรายเดือน': 'Monthly sales trend',
  'ทำยอดทะลุเป้า': 'Target exceeded',
  'เติบโต': 'Growth',
  'ปิดได้': 'Won',
  'เดือนล่าสุดโตขึ้น': 'Latest month grew',
  'ปิดสำเร็จ': 'closed',
  'มูลค่ารวมทั้งหมด': 'Total value',
  'ดูลูกค้าทั้งหมด →': 'View all customers →',
  'ปิดได้แล้ว': 'Closed won',
  'ความคืบหน้าเป้าหมาย': 'Goal progress',
  'ใกล้แล้ว': 'Almost there',
  'มูลค่ารวมสะสมทั้งหมด': 'Total accumulated value',
};
